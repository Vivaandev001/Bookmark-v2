      ...
      {isOpen && (
        <div id="welcome-popup" className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 bg-bg-darkest/90 backdrop-blur-xl"
          />

          {/* Cinematic lighting spots behind welcome card */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 h-[300px] w-[300px] rounded-full bg-accent-primary/5 blur-[80px]" />
          ...
          <motion.div
            ...
            className="relative w-full max-w-md rounded-3xl border border-white/10 bg-card-dark/80 p-8 shadow-2xl backdrop-blur-md text-center overflow-hidden"
          >
            {/* Visual Header Icon */}
            ...
            >
              <span className="inline-flex items-center gap-1.5 rounded-full border border-accent-text/20 bg-accent-primary/5 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-accent-text mb-4">
