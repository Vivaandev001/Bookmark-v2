    ...
    >
      ...
      >
        {items.map((label, index) => (
          ...
          >
            {/* Minimalist Gradient Background Pill */}
            <div 
              className="absolute -inset-x-3 -inset-y-1 rounded-lg -z-10 pointer-events-none"
              style={{
                background: 'linear-gradient(90deg, rgba(103, 232, 249, 0.08) 0%, rgba(103, 232, 249, 0.02) 100%)',
                opacity: 'var(--effect, 0)',
                border: '1px solid rgba(103, 232, 249, calc(var(--effect, 0) * 0.15))'
              }}
            />
            {showMarker && (
              <span
